...
public:
  ...
  void setMasses(double m0, double m1, double m2) {
    M0 = m0;
    M1 = m1;
    M2 = m2;
  }
  void setCharges(int z0, int z1, int z2) {
    Z0 = z0;
    Z1 = z1;
    Z2 = z2;
  }
  void setSpins(double j0, double j1, double j2) {
    J0 = j0;
    J1 = j1;
    J2 = j2;
  }
  void setSeparationEnergies(double qin, double qout) {
    Q = qin;
    Qexit = qout;
  }
  ...
  void addResonance(int, double, double, double, double, double, double, double,
                    int, double, double, double, double, int, double, double,
                    double, double, int, double, double, double, bool, bool,
                    bool, bool, int, double);
  void addInterference(int, int);
  void addResonanceToInterference(int, double, double, double, double, double,
