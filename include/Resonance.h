...
public:
  // Constructor
  Resonance(Reaction &R, int index = 0, double E_cm = 0.0, double dE_cm = 0.0,
            double wg = 0.0, double dwg = 0.0, double Jr = 0.0,
            double G[3] = defaultdinit, double dG[3] = defaultdinit,
            int L[3] = defaultiinit, double PT[3] = defaultdinit,
            double dPT[3] = defaultdinit, double Exf = 0, bool bInt = false,
            bool bUpperLimit = false, bool isECorrelated = false,
            bool isWidthCorrelated = false, int CorresRes = 0,
            double Frac = 1.0);
  // Destructor
  ~Resonance();
  ...
  void makeSamples(std::vector<std::vector<double>> Ref_sample,
                   double smallestdE, double smallestdwg, double smallestdG[3]);
  ...
  double NumericalRate(double T, double E, double G0, double G1, double G2,
